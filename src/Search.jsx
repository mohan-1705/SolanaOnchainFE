      ...
      <div className="flex flex-col gap-3 items-center justify-center text-black my-6 px-5 text-center">
        ...
        <div className="text-left flex flex-col gap-3 text-gray-400 my-7">
          <div className="justify-center">
            <span className="text-2xl text-gray-500">#1</span> Get access to a PubKey you want to start exploring, Ex: EBwMpd2zHKJuG3qxqBgLgNYpjS9DJLtPpG2CytcJqhJL
          </div>
          <hr />
          <div>
            <span className="text-2xl text-gray-500">#2</span> Enter the Wallet Pubkey in the search bar above
          </div>
          <hr />
          <div>
