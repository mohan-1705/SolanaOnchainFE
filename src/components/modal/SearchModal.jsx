...
const SearchModal = ({ isModalOpen, setIsModalOpen }) => {
  const { selectedChain,  setChain, chain, detectedChain, setChainImage, chainImage} =
      ...
      {isModalOpen && (
        <div className="absolute top-10 left-[-10px] p-2 bg-white border-2 border-slate-400 shadow-lg rounded-xl">
          <div className="flex justify-center items-center gap-4">
            ...
            <ChainDropdown selectedChain={selectedChain} setChain={setChain} setChainImage={setChainImage}/>
            <AutocompleteBar
              searchInput={search}
